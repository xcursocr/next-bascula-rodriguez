  ...
  return (
    <>
      {isOpen && (
        <div
          ref={menuRef}
          className={` top-12 right-0 fixed  flex-column bg-background shadow-md  w-64 h-screen  border-l-1 border-t-1 border-primary transition-all transition-discrete duration-150 animate-fade-in-scale`}
        >
          <ul className="w-full">
